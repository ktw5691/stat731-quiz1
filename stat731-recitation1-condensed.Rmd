...
- We obtained $`r nheads`$ "Heads" out of $`r n`$ tosses of a fair coin
- Therefore, $Pr\left[H\right] = `r round(nheads / n, 4)`$
...
`r round(table(scams)[1] / length(scams) * 100, 2)`% of the flips landed on
"Heads"
...
- We empirically obtain $`r outcome`$ out of $`r n`$ rolls
- Our empirical estimate of $Pr[f_1 = f_2] = `r round(outcome / n, 4)`$
...
- We observed $`r outcome`$ events where $X = -2$ out of $`r n`$ samples
- Our empirical estimate of $Pr[X = -2] = `r round(outcome / n, 4)`$
- How does this compare to our theoretical expectation?
...
- We observed $`r outcome`$ events where $X \ge 0$ out of $`r n`$ samples
- Our empirical estimate of $Pr[X \ge 0] = `r round(outcome / n, 4)`$
- How does this compare to our theoretical expectation?
...
- We have `r n2words` two-letter words
...
- We have `r n3words` possible three-letter words
...
- We have `r n4words` four-letter words
